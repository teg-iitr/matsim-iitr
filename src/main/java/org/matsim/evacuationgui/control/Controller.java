...
import org.matsim.evacuationgui.io.EvacuationConfigWriter;
import org.matsim.evacuationgui.io.ShapeIO;
...
import org.matsim.evacuationgui.model.ModuleChain;
...
import org.matsim.evacuationgui.model.shape.LineShape;
...
import org.matsim.evacuationgui.populationselector.PopAreaSelector;
import org.matsim.evacuationgui.view.DefaultOpenDialog;
import org.matsim.evacuationgui.view.DefaultRenderPanel;
import org.matsim.evacuationgui.view.DefaultWindow;
import org.matsim.evacuationgui.view.Visualizer;
import org.matsim.evacuationgui.view.renderer.AbstractRenderLayer;
...
public class Controller {
	...
	private void processNetwork(boolean processLinks) {
		...
		this.boundingBox = new Double(min.getY(), min.getX(), max.getY() - min.getY(), max.getX() - min.getX());
	}
