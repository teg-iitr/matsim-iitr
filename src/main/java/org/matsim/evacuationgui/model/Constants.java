...
import org.matsim.evacuationgui.model.locale.EnglishLocale;
import org.matsim.evacuationgui.model.locale.Locale;
import org.matsim.evacuationgui.model.shape.Shape.DrawMode;
import org.matsim.evacuationgui.model.shape.ShapeStyle;
...
public class Constants
{
	...
	public static Color getModuleColor(ModuleType type)
	{
		...
		{
			case EVACUATION:
				return MENU_COLOR_EVACUATION;
			case POPULATION:
				return MENU_COLOR_POPULATION;
			case EVACUATIONSCENARIO:
				return MENU_COLOR_EVACUATIONSCENARIO;
			case ROADCLOSURE:
				return MENU_COLOR_ROADCLOSURE;
			case ANALYSIS:
				return MENU_COLOR_ANALYSIS;
			case MATSIMSCENARIO:
				return MENU_COLOR_MATSIMSCENARIO;
			case SCENARIOXML:
				return MENU_COLOR_SCENARIOXML;
		}
		return null;
	}
	...
	public enum ModuleType {
		EVACUATION, POPULATION, ROADCLOSURE, ANALYSIS, MATSIMSCENARIO, SCENARIOXML, EVACUATIONSCENARIO
	}

	public enum LayerType {SLIPPYMAP, SHAPE, LINES, INFO, MISC}

	public enum Mode {EVACUATION, UTILIZATION, CLEARING}

	public enum SelectionMode {POLYGONAL, CIRCLE}
