...
public class EvacuationAnalysis extends AbstractModule {
    ...
    private org.matsim.evacuationgui.analysis.EAToolBox toolBox;
    ...
    public AbstractToolBox getToolBox() {
        if (this.toolBox == null) {
            this.toolBox = new org.matsim.evacuationgui.analysis.EAToolBox(this, this.controller);
        }
        return this.toolBox;
    }
...
//                this.toolBox.getOpenOTFVisBtn().setEnabled(true);
            ...
            ((org.matsim.evacuationgui.analysis.EAToolBox) getToolBox()).setEventFileItems(eventFiles);
        }
        if ((graphPanel == null) || (keyPanel == null)) {
            graphPanel = ((org.matsim.evacuationgui.analysis.EAToolBox) getToolBox()).getGraphPanel();
            keyPanel = ((org.matsim.evacuationgui.analysis.EAToolBox) getToolBox()).getKeyPanel();
        }
