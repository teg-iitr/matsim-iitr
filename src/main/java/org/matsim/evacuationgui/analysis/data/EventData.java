...
package org.matsim.evacuationgui.analysis.data;
...
import org.matsim.evacuationgui.analysis.data.AttributeData;
import org.matsim.evacuationgui.analysis.data.Cell;
...
public class EventData<C> {
	...
	private QuadTree<org.matsim.evacuationgui.analysis.data.Cell> cellTree;
	...
	public EventData(String eventName, QuadTree<org.matsim.evacuationgui.analysis.data.Cell> cellTree, double cellSize, double timeSum, double maxCellTimeSum, int arrivals, List<Tuple<Double, Integer>> arrivalTimes, Rect boundingBox) {
	...
	public QuadTree<org.matsim.evacuationgui.analysis.data.Cell> getCellTree() {
		return cellTree;
	}

	public void setCellTree(QuadTree<org.matsim.evacuationgui.analysis.data.Cell> cellTree) {
		this.cellTree = cellTree;
	}
	...
	public LinkedList<org.matsim.evacuationgui.analysis.data.Cell> getCells() {
		LinkedList<org.matsim.evacuationgui.analysis.data.Cell> cells = new LinkedList<Cell>();
