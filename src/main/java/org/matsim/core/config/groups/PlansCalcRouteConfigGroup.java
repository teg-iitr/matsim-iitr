...
public final class PlansCalcRouteConfigGroup extends ConfigGroup {
	...
	private Collection<String> networkModes = (Collection<String>) Collections.singletonList( TransportMode.car );
	...
	private static final String ISINSERTINGACCESSEGRESSWALK = null;
...
//		}
	...
	public void addParam(final String key, final String value, Object ISINSERTINGACCESSEGRESSWALK) {
...
//		TODO: uncomment this for release 13.0
	...
	private void setInsertingAccessEgressWalk(AccessEgressType valueOf) {
