...
//private int code;
//private String name;
//private RouteType simpleRouteType;
//private RouteType extendedRouteType;
//
//private RouteType(int code, String name, RouteType extendedType) {             //format for the extended type
//	this.code =code;
//	this.name =name;
//	this.extendedRouteType =extendedType;
//		}
//
//private RouteType(int code,String name) {                                   //format for the simple type
//	this.code=code;
//	this.name =name;
//}
//
