...
//        public static Link endLink3 = SouthDelhiTransitSchedulerCreator.scenario.getNetwork().getLinks().get(Id.create("5542886270001f", Link.class));
        ...
        public static final ArrayList<Id<Link>> getLinkList1() {
                ...
                linkList1.add(Id.create("317565100003f", Link.class));
        ...
        public static final ArrayList<Id<Link>> getLinkList2() {
                ...
                linkList2.add(Id.create("317565100003f", Link.class));
                ...
                linkList2.add(Id.create("1912048840014f", Link.class));
                linkList2.add(Id.create("5606511090000f", Link.class));
                ...
                linkList2.add(Id.create("5551971890002f",Link.class));
        ...
        public static final ArrayList<Id<Link>> getLinkList3() {
                ...
                linkList3.add(Id.create("5551971890002f",Link.class));
